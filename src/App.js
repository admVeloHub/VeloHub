...
// Componente da Página de Apoio
const ApoioPage = () => {
    const supportItems = [
        { name: 'Artigo', icon: <FileText size={40} /> }, 
        { name: 'Processo', icon: <Bot size={40} /> },
        { name: 'Treinamento', icon: <GraduationCap size={40} /> }, 
        { name: 'Roteiro', icon: <Route size={40} /> },
        { name: 'Funcionalidade', icon: <Puzzle size={40} /> }, 
        { name: 'Recurso Adicional', icon: <PlusSquare size={40} /> },
    ];
    return (
