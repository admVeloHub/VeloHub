 ...
 * VERSION: v1.3.0 | DATE: 2026-06-10 | AUTHOR: VeloHub Development Team
 *
 * Referência (duas entradas; detalhes no Git):
 * - v1.3.0: SLA — Reclame Aqui (prazoReclameAqui)
...
/** BACEN, N2 Pix, Procon e Reclame Aqui possuem prazo no schema. */
export const reclamacaoTemCampoPrazoSla = (tipo) => {
  ...
  if (u === 'RECLAME AQUI' || u === 'RECLAME_AQUI' || u === 'RECLAMEAQUI') return true;
  return false;
};

export const getPrazoRawReclamacao = (r) => {
  if (!r) return null;
  return r.prazoBacen || r.prazoOuvidoria || r.prazoProcon || r.prazoReclameAqui || null;
};
