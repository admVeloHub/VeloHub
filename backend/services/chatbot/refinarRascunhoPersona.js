/**
 * Persona estática do fluxo «Refinar Rascunho» (Gemini) — página Processos / VeloBot
 * VERSION: v1.1.0 | DATE: 2026-05-06 | AUTHOR: VeloHub Development Team
 *
 * v1.1.0: saída estritamente o e-mail formalizado (sem rascunho, análise, seções nem preâmbulo).
 * v1.0.0: alinhamento briefing Velotax / produtos permitidos.
 */

function getRefinarRascunhoPersona() {
  return `# PERSONA
...
module.exports = { getRefinarRascunhoPersona };
