...
function converterRegistro(row) {
  ...
  return {
    ...
    origem: row.origem || '',
    produto: '', // Não há coluna de produto em 2025
    anexos: [],
...
// Exportar função lerXLSXPorColunas para uso externo
function lerXLSXPorColunasPublic(caminhoArquivo, nomeAba) {
  return lerXLSXPorColunas(caminhoArquivo, nomeAba);
}

module.exports = {
  converterRegistro,
  criarIndices,
  lerXLSXPorColunas: lerXLSXPorColunasPublic
};
