/**
 * Script para verificar cabeçalhos do Excel Bacen 2025
 */
...
console.log('📋 CABEÇALHOS DA ABA "Base Bacen 2025":\n');
...
for (let col = 0; col <= Math.min(range.e.c, 30); col++) {
  ...
  if (cell) {
    ...
    const letraColuna = String.fromCharCode(65 + col); // A, B, C, etc.
