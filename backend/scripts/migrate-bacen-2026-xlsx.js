 ...
 * 
 * Processa aba "Base Bacen 2026" do arquivo XLSX e insere na collection reclamacoes_bacen
 ...
 * 
 * Uso:
 *   node backend/scripts/migrate-bacen-2026-xlsx.js [--dry-run]
 * 
...
async function main() {
  ...
  try {
    ...
    // Limpar collection apenas se estiver vazia (Bacen 2025 já limpou)
    if (!DRY_RUN) {
