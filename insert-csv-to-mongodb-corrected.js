        ...
        fs.createReadStream('CENTRAL INTERNA - INPUT - Artigos.csv')
            ...
            .on('data', (row) => {
                ...
                if (category === 'Ferramentas do Agente') {
                    ...
                    // Vai para Artigos (todas as outras categorias)
                    articles.push({
                        title: title,
                        content: content,
                        category: category,
            ...
            .on('end', async () => {
                ...
                try {
                    // Limpar collections existentes antes de inserir
                    ...
                    await artigosCollection.deleteMany({});
                    ...
                    console.log(`- Velonews: ${velonews.length}`);
                    console.log(`- FAQ: ${faq.length}`);
                    console.log(`- TOTAL: ${articles.length + velonews.length + faq.length} documentos`);
                    console.log('\n🎉 TODOS os dados do CSV foram inseridos com sucesso!');
